...
const handleProps = ({ categories, courses }) => ({
...
class Courses extends Component {
  constructor(props) {
    super(props);
    this.state = handleProps({ categories: props.categories, courses: props.courses });
  }
  ...
  getRows() {
    ...
    return this.state.courses.sort((a, b) => {
      let ret = 0;
      ...
      <div className="skills">
        ...
        <div className="title">
          ...
          <p>Note: I think these sections are silly, but everyone seems to have one.
            Here is a *mostly* honest overview of my courses.
          </p>
        </div>
